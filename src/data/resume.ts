...
export const uiText: Record<Language, Record<string, string>> = {
  pt: {
    ...
    noProjectsFound: 'Nenhum projeto encontrado com a tecnologia selecionada.',
    all: 'Todos',
    fullStack: 'Full Stack',
    frontend: 'Frontend',
    projectsDescription: 'Confira alguns dos meus projetos mais recentes, demonstrando habilidades em diferentes tecnologias e abordagens de desenvolvimento.',
  },
  en: {
    contact: 'Contact',
    ...
    noProjectsFound: 'No projects found with the selected technology.',
    all: 'All',
    fullStack: 'Full Stack',
    frontend: 'Frontend',
    projectsDescription: 'Check out some of my most recent projects, demonstrating skills in different technologies and development approaches.',
  },
};
